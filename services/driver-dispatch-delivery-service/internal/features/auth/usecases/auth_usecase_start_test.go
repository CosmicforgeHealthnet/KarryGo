...
func (f *fakeOTPRepository) LatestByPhoneAndPurpose(ctx context.Context, phone, purpose string) (authmodels.OTP, bool, error) {
	otp, ok := f.latest[phone]
...
func (e *errPublisher) PublishPhoneChanged(_ context.Context, _ authclients.PhoneChangedEvent) error {
	return apperrors.Internal("redis publish failed", nil)
}

func (f *fakePublisher) PublishPhoneChanged(_ context.Context, _ authclients.PhoneChangedEvent) error {
	return nil
}
