...
func (r *slIdentityRepo) UpdatePhone(_ context.Context, _, _, _ string) error { return nil }
func (r *slIdentityRepo) UpdateEmail(_ context.Context, _, _ string) error   { return nil }
...
func (r *slSessionRepo) RevokeAllByDispatchRiderID(ctx context.Context, dispatchRiderID string) (int64, error) {
	var count int64
...
func (p *slFakePublisher) PublishPhoneChanged(_ context.Context, _ authclients.PhoneChangedEvent) error {
	return nil
}
