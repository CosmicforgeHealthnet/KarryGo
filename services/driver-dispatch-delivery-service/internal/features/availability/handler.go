...
func (h *Handler) PatchAvailability(c *gin.Context) {
	...
	httpx.RespondSuccess(c, http.StatusOK, "Availability updated.", response)
}
...
func (h *Handler) GetAvailability(c *gin.Context) {
	...
	httpx.RespondSuccess(c, http.StatusOK, "Availability loaded.", response)
}
...
func (h *Handler) GetCurrentSession(c *gin.Context) {
	...
	httpx.RespondSuccess(c, http.StatusOK, "Current availability session loaded.", response)
}
...
func (h *Handler) GetLocation(c *gin.Context) {
	...
	httpx.RespondSuccess(c, http.StatusOK, "Location loaded.", response.Location)
}
...
func (h *Handler) GetNearby(c *gin.Context) {
	...
	httpx.RespondSuccess(c, http.StatusOK, "Nearby providers loaded.", response)
}
