...
type Repository interface {
	...
	GetLicenceExpiryDate(ctx context.Context, providerID string) (*time.Time, error)
...
func (r *PostgresRepository) GetLicenceExpiryDate(ctx context.Context, providerID string) (*time.Time, error) {
	row := r.db.QueryRow(ctx, `
