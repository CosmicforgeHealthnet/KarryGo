...
const (
	...
	TopicCustomerRated          = "provider.rated_customer"
)
...
// CustomerRatedEvent is published after a provider rates a customer (GAP 4).
type CustomerRatedEvent struct {
	Event         string    `json:"event"`
	CorrelationID string    `json:"correlation_id,omitempty"`
