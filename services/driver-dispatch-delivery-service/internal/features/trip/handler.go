...
func (h *Handler) ListTrips(c *gin.Context) {
	...
	httpx.RespondSuccess(c, http.StatusOK, "Trips loaded.", result)
}
...
func (h *Handler) GetActiveTrip(c *gin.Context) {
	...
	httpx.RespondSuccess(c, http.StatusOK, "Active trip loaded.", result)
}
...
func (h *Handler) GetTrip(c *gin.Context) {
	...
	httpx.RespondSuccess(c, http.StatusOK, "Trip loaded.", result)
}
...
func (h *Handler) GetProof(c *gin.Context) {
	...
	httpx.RespondSuccess(c, http.StatusOK, "Delivery proof loaded.", result)
}
...
func (h *Handler) MarkArrived(c *gin.Context) {
	...
	httpx.RespondSuccess(c, http.StatusOK, result.Message, result)
}
...
func (h *Handler) StartTrip(c *gin.Context) {
	...
	httpx.RespondSuccess(c, http.StatusOK, "Delivery started. Head to the drop-off location.", result)
}
...
func (h *Handler) SubmitProof(c *gin.Context) {
	...
	httpx.RespondSuccess(c, http.StatusCreated, result.Message, result)
}
...
func (h *Handler) CancelTrip(c *gin.Context) {
	...
	httpx.RespondSuccess(c, http.StatusOK, "Trip cancelled.", result)
}
