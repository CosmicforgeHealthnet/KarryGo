...
func (h *Handler) ListInbox(c *gin.Context) {
	...
	apiresponse.RespondSuccess(c, http.StatusOK, "Request inbox loaded.", result)
}
...
func (h *Handler) GetRequest(c *gin.Context) {
	...
	apiresponse.RespondSuccess(c, http.StatusOK, "Request loaded.", detail)
}
...
func (h *Handler) AcceptRequest(c *gin.Context) {
	...
	apiresponse.RespondSuccess(c, http.StatusOK, "Request accepted.", result)
}
...
func (h *Handler) RejectRequest(c *gin.Context) {
	...
	apiresponse.RespondSuccess(c, http.StatusOK, "Request rejected.", result)
}
