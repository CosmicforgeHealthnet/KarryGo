...
| Module | `karrygo/services/driver-dispatch-delivery-service` |
| Port | `8103` |
...
GIN_MODE=debug
HTTP_ADDR=:8103
DISPATCH_DELIVERY_DATABASE_URL=postgres://karrygo:karrygo@localhost:5435/dispatch_delivery_service?sslmode=disable
...
```powershell
psql "postgres://karrygo:karrygo@localhost:5435/dispatch_delivery_service?sslmode=disable" -f services/driver-dispatch-delivery-service/migrations/001_dispatch_rider_auth.sql
psql "postgres://karrygo:karrygo@localhost:5435/dispatch_delivery_service?sslmode=disable" -f services/driver-dispatch-delivery-service/migrations/002_dispatch_rider_auth_alter.sql
```

Rollback in reverse order:

```powershell
psql "postgres://karrygo:karrygo@localhost:5435/dispatch_delivery_service?sslmode=disable" -f services/driver-dispatch-delivery-service/migrations/002_dispatch_rider_auth_alter_down.sql
psql "postgres://karrygo:karrygo@localhost:5435/dispatch_delivery_service?sslmode=disable" -f services/driver-dispatch-delivery-service/migrations/001_dispatch_rider_auth_down.sql
```
