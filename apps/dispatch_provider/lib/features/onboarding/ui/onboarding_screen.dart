...
class _OnboardingScreenState extends State<OnboardingScreen> {
  ...
  static const _steps = [
    _OnboardingStep(
      ...
      body:
          "Whether you're sending a package or delivering one, KarryGo connects you to the fastest, safest routes and helps you earn or get deliveries done on time.",
    ),
    _OnboardingStep(
      image: 'assets/figma/onboarding_car.png',
      title: 'Ride or Drive on your Terms!',
      body:
          'Book a ride instantly or pick up passengers nearby. KarryGo makes every trip simple, efficient, and rewarding for both riders and drivers.',
    ),
    _OnboardingStep(
      image: 'assets/figma/onboarding_truck.png',
      title: 'Move Big, Move Smart!',
      body:
          'Transport goods, materials, or equipment with confidence. KarryGo helps you find the right loads, optimize trips, and earn while delivering safely.',
      isLast: true,
    ),
  ];
                      ...
                      children: List.generate(_steps.length, (i) {
                        ...
                        return Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            color: isActive
                                ? const Color(0xFF27A747) // Active indicator #27A747
...
class _KarryGoWaveClipper extends CustomClipper<Path> {
  @override
  ...
  @override
  bool shouldReclip(_KarryGoWaveClipper oldClipper) => false;
}
