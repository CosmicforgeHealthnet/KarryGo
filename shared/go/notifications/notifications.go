...
const (
	...
	EventDriverEnRoutePickup        = "booking.en_route_pickup"
	EventDriverArrivedPickup        = "booking.arrived_at_pickup"
	EventDriverEnRouteDelivery      = "booking.en_route_delivery"
